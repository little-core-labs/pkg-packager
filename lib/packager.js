...
/**
 * The `Packager` class is the top level object for specifying
 * packaging targets in a batch that can be built and packaged into
 * formats suitable for Linux, macOS, and Windows.
 * @public
 * @class
 */
class Packager {
